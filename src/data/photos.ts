    ...
    plates: [
      {
        ...
        title: 'A new heart \n· *Danio rerio* \n斑马鱼的初生心管',
        caption: '新生的心脏',
        note: 'ZEISS 980 confocal microscope · 心肌细胞膜被荧光蛋白eGFP标记',
        alt: '共聚焦',
      },
      {
        file: 'micro/zebrafishheart.png',
        title: 'Looping \n· *Danio rerio* \n斑马鱼的心脏',
        caption: '授精后3天的斑马鱼心脏',
        note: '心ZEISS 980 confocal microscope · 肌细胞膜被荧光蛋白eGFP标记',
        alt: '共聚焦',
      },
                  {
        file: 'micro/ancientbrain.png',
        title: 'Innervation \n· *Branchiostoma floridae* \n文昌鱼的脑泡和周边神经',
        caption: '原始的脊索动物中枢神经系统',
        note: 'ZEISS 980 confocal microscope · actubulin dyed',
        alt: '共聚焦',
      },
       {
        file: 'micro/brain.png',
        title: 'Complexity \n· *Danio rerio* \n斑马鱼的脑和周边神经',
        caption: '具有典型的脊椎动物脑分区结构',
        note: 'ZEISS 980 confocal microscope · actubulin dyed',
        alt: '共聚焦',
      },
      {
        ...
        caption: '海胆',
        note: 'ZEISS 980 confocal microscope · 细胞核用DAPI染色',
        alt: '共聚焦',
      },
       {
        file: 'micro/fin.png',
        title: 'Fish also has hand \n· *Danio rerio* \n新生的胸鳍',
        caption: '红色是肌肉纤维，圆形细胞核是间充质',
        note: 'ZEISS 980 confocal microscope · phalloidin dyed',
        alt: '共聚焦',
      },
  ...
  /* ---------- 画廊 03：自然生境 ---------- */
  {
    ...
    plates: [
      ...
      },
      {
        ...
        title: '生境 · 尖峰岭自然保护区',
        caption: '鸣凤谷',
        note: 'Pentax KX · FOMAPAN 100 · 海拔800m',
        alt: 'NA',
      },
      {
        ...
        title: '生境 · 尖峰岭自然保护区',
        caption: '尖峰岭主峰',
        note: 'Pentax KX · FOMAPAN 100 · 海拔1400m',
        alt: 'NA',
      },
    ],
  },
